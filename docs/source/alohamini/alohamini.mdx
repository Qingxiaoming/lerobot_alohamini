...
> **Prerequisites:** complete [installation.mdx](installation.mdx) first.  
> **Hardware profiles:** see [profiles.mdx](profiles.mdx).
...
![Calibration SO-ARM](media/mid_position_so100.png)
...
See the
[debug tool reference](https://github.com/Qingxiaoming/lerobot_alohamini/blob/main/docs/modules/examples/debug-tools.md)
for the full list of debugging utilities.
